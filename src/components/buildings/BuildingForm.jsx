...
export default function BuildingForm({ building, buildingCommittees, onSubmit, onCancel }) {
  ...
  const handleSubmit = (e) => {
    ...
    const dataToSubmit = {
      ...
      details: {
        ...formData.details,
        total_floors: formData.details.total_floors ? parseInt(formData.details.total_floors) : null,
        year_built: formData.details.year_built ? parseInt(formData.details.year_built) : null
      },
      building_committee: {
        ...formData.building_committee,
        monthly_fee: formData.building_committee.monthly_fee ? 
          parseFloat(formData.building_committee.monthly_fee) : null,
        payment_day: formData.building_committee.payment_day ? 
          parseInt(formData.building_committee.payment_day) : null
      }
    };
    ...
    <Card className="p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => handleInputChange('details.total_floors', e.target.value)}
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => handleInputChange('details.year_built', e.target.value)}
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-semibold">מתקנים בבניין</h3>
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-semibold">ועד בית</h3>
          <div className="grid md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="committee_id">מזהה ועד</Label>
              <Input
                id="committee_id"
                value={formData.building_committee?.committee_id || ''}
                onChange={(e) => handleInputChange('building_committee.committee_id', e.target.value)}
                placeholder="מזהה ועד הבית (אם יש)"
              />
            </div>
            <div className="space-y-2">
              <Label htmlFor="monthly_fee">דמי ועד חודשי</Label>
              <Input
                id="monthly_fee"
                type="number"
                value={formData.building_committee?.monthly_fee || ''}
                onChange={(e) => handleInputChange('building_committee.monthly_fee', e.target.value)}
                placeholder="סכום דמי הועד"
              />
            </div>
          </div>
        </div>
